...
| Plan | Description | PR / Git References |
|------|-------------|---------------------|
| [Remove Windows Support](todo/2026-05-08-remove-windows-support.md) | Remove all Windows-specific code, CI, build targets, dependencies, and documentation | 🚧 IN PROGRESS |
