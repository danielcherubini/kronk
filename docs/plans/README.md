...
| [Docker Backend](2026-04-30-docker-backend.md) | Add BackendType::Docker with compose YAML management, container lifecycle (start/stop/health/restart), template picker, and SSE log streaming | #83 `5a2421d`–`42ac268` ✅ COMPLETED |
