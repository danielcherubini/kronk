...
|------|-------------|---------------------|
| [Unified Server](2026-05-20-unified-server.md) | Merge proxy (11434) and web UI (11435) into single server on one port, mount web UI at /ui, add backend forwarding | `d9204add` (merged directly to main) ✅ COMPLETED |
